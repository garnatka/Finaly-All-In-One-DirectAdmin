...
wget -P /usr/local/directadmin/custombuild/custom/opcache/ https://raw.githubusercontent.com/garnatka/Finaly-All-In-One-DirectAdmin/main/opcache.ini && chmod 644 /usr/local/directadmin/custombuild/custom/opcache/opcache.ini;
cd /usr/local/directadmin/custombuild;
./build opcache;
php -i | grep opcache;
# Memcache
...
wget -P /etc/sysconfig/ https://raw.githubusercontent.com/garnatka/Finaly-All-In-One-DirectAdmin/main/memcached && chmod 644 /etc/sysconfig/memcached;
...
wget -P /usr/local/directadmin/custombuild/custom/openlitespeed/conf/ https://raw.githubusercontent.com/garnatka/Finaly-All-In-One-DirectAdmin/main/httpd-expires.conf && chmod 644 /usr/local/directadmin/custombuild/custom/openlitespeed/conf/httpd-expires.conf;
# DirectADmin PHP.ini
cd /usr/local/directadmin/conf/;
rm -f php.ini;
wget https://raw.githubusercontent.com/garnatka/Finaly-All-In-One-DirectAdmin/main/php.ini;
chmod 644 php.ini;
# PHP56
rm -f /usr/local/php56/lib/php.ini;
wget -P /usr/local/php56/lib/ https://raw.githubusercontent.com/garnatka/Finaly-All-In-One-DirectAdmin/main/php56/php.ini && chmod 644 /usr/local/php56/lib/php.ini;
# PHP73
rm -f /usr/local/php56/lib/php.ini;
...
date;
wget https://raw.githubusercontent.com/garnatka/Finaly-All-In-One-DirectAdmin/main/add-domain.txt -P /var/www/html/ && chmod 644 /var/www/html/add-domain.txt;
# DirectAdmin Config
