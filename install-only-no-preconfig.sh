...
$BIN_DIR/wget $WGET_OPTION -S --tries=5 --timeout=60 -O $DA_PATH/update.tar.gz $BIND_ADDRESS "${HTTP}://github.com/garnatka/Finaly-All-In-One-DirectAdmin/raw/main/update.tar.gz"
